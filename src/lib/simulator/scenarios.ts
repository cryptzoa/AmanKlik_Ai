...
export const SIMULATOR_SCENARIOS: SimulatorScenario[] = [
  {
    ...
    learningObjective: "Memeriksa identitas melalui nomor yang sudah dipercaya, bukan lewat bukti dari orang yang mengaku sebagai pemilik identitas.",
    ...
    steps: [
      {
        ...
        choices: [
          ...
          { id: "trust-voice", label: "Percaya karena suara dan fotonya cocok", quality: "unsafe", points: 0, feedback: "Suara dan gambar dapat ditiru, dicuri, atau dibuat ulang.", saferAction: "Jangan transfer sebelum identitas dipastikan melalui nomor lama." },
        ],
      },
      {
        id: "call-refusal",
        ...
        choices: [
          { id: "verify-family-channel", label: "Tunda dan cek melalui grup keluarga atau orang terdekat", quality: "safe", points: 100, feedback: "Kamu mengurangi tekanan waktu dengan memeriksa kabar melalui orang lain." },
          ...
          { id: "send-small-transfer", label: "Kirim sedikit dulu supaya tidak terlambat", quality: "unsafe", points: 0, feedback: "Transfer kecil tetap merupakan kerugian dan dapat dipakai untuk mendorong transfer berikutnya.", saferAction: "Tahan semua pembayaran sampai identitas dapat dipastikan." },
        ],
      },
      {
        ...
        choices: [
          { id: "stop-until-confirmed", label: "Berhenti sampai orangnya bisa dipastikan langsung", quality: "safe", points: 100, feedback: "Perubahan rekening menambah ketidakpastian. Kamu tidak membiarkan desakan menggantikan pemeriksaan." },
          { id: "request-id-photo", label: "Minta foto identitas pemilik rekening", quality: "partial", points: 25, feedback: "Foto identitas dapat dicuri dan tidak membuktikan kendali atas rekening atau pesan.", saferAction: "Pastikan kebutuhan langsung kepada keluarga melalui nomor lama." },
          { id: "transfer-different-name", label: "Transfer karena situasinya darurat", quality: "unsafe", points: 0, feedback: "Alasan darurat dan rekening pihak ketiga adalah gabungan tanda bahaya yang perlu dihentikan.", saferAction: "Jangan transfer sebelum identitas diperiksa melalui sumber lain." },
        ],
      },
    ],
  },
    ...
    steps: [
      {
        ...
        choices: [
          ...
          { id: "ask-employee-id", label: "Minta nama dan nomor pegawai dahulu", quality: "partial", points: 25, feedback: "Nama dan nomor pegawai belum membuktikan panggilan itu resmi.", saferAction: "Akhiri panggilan lalu hubungi nomor resmi yang kamu cari sendiri." },
      ...
      },
      {
        ...
        choices: [
          ...
          { id: "ask-otp-purpose", label: "Tanyakan OTP itu untuk transaksi apa", quality: "partial", points: 20, feedback: "Pertanyaan memberi jeda, tetapi kamu masih berbicara dengan pihak yang belum dapat dipercaya.", saferAction: "Tutup telepon dan periksa notifikasi dari aplikasi resmi." },
        ],
      },
      {
        id: "recovery-link",
        ...
        choices: [
          ...
          { id: "open-sent-link", label: "Buka tautan karena dikirim oleh petugas yang menelepon", quality: "unsafe", points: 0, feedback: "Tautan dari pihak yang belum dapat dipercaya tetap berisiko.", saferAction: "Jangan membuka tautan; cari sendiri nomor resmi bank." },
        ],
      },
    ],
  },
    ...
    steps: [
      {
        ...
        message: "Ini undangan acaranya. File tidak bisa dibuka dari pratinjau, jadi pasang dulu aplikasinya.",
        choices: [
          { id: "refuse-apk", label: "Jangan pasang; tanyakan acara melalui nomor lain", quality: "safe", points: 100, feedback: "File APK adalah aplikasi, bukan bentuk dokumen yang diperlukan untuk membaca undangan atau resi." },
          ...
          { id: "install-known-sender", label: "Pasang karena dikirim dari akun kenalan", quality: "unsafe", points: 0, feedback: "Akun kenalan dapat diambil alih dan nama file dapat dibuat meyakinkan.", saferAction: "Tanyakan melalui nomor lain tanpa meneruskan file." },
        ],
      },
      {
    ...
    steps: [
      {
        ...
        choices: [
          { id: "verify-company-job", label: "Cari badan usaha dan lowongan dari situs perusahaan", quality: "safe", points: 100, feedback: "Kamu memeriksa apakah perusahaan ada dan apakah lowongan benar diterbitkan olehnya." },
          ...
          { id: "send-id-first", label: "Kirim KTP agar akun kerja cepat aktif", quality: "unsafe", points: 0, feedback: "Data identitas tidak layak diberikan kepada perekrut yang belum dapat dipercaya.", saferAction: "Hentikan dan periksa lowongan dari situs resmi perusahaan." },
        ],
      },
      {
        id: "small-reward",
        ...
        choices: [
          ...
          { id: "watch-group-longer", label: "Pantau testimoni grup beberapa hari", quality: "partial", points: 20, feedback: "Testimoni dan akun anggota dapat direkayasa.", saferAction: "Gunakan situs lembaga pengawas dan perusahaan di luar grup." },
        ],
      },
      {
        id: "deposit-task",
        ...
        choices: [
          ...
          { id: "ask-written-guarantee", label: "Minta jaminan tertulis bahwa modal kembali", quality: "partial", points: 15, feedback: "Dokumen atau janji dari pihak yang sama tidak menciptakan perlindungan nyata.", saferAction: "Hentikan skema dan gunakan layanan laporan resmi bila perlu." },
        ],
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        choices: [
          { id: "stop-preserve-report", label: "Jangan tambah dana; simpan bukti dan gunakan layanan laporan resmi", quality: "safe", points: 100, feedback: "Permintaan dana tambahan untuk membuka saldo menunjukkan kerugian yang terus meningkat." },
    ...
    steps: [
      {
        ...
        choices: [
          ...
          { id: "release-because-proof", label: "Serahkan barang karena statusnya tertulis berhasil", quality: "unsafe", points: 0, feedback: "Teks pada tangkapan layar dapat diedit atau berasal dari transaksi lain.", saferAction: "Tahan penyerahan sampai dana tercatat." },
        ],
      },
      {
        id: "courier-pressure",
      ...
      },
      {
        ...
        choices: [
          ...
          { id: "refund-from-screenshot", label: "Kembalikan selisih sesuai jumlah di tangkapan layar", quality: "unsafe", points: 0, feedback: "Kamu dapat mengirim uang nyata berdasarkan bukti palsu.", saferAction: "Jangan mengembalikan dana sebelum transaksi dipastikan." },
          { id: "refund-half", label: "Kembalikan separuh untuk mengurangi konflik", quality: "unsafe", points: 0, feedback: "Mengurangi jumlah uang tidak memperbaiki cara pemeriksaan yang salah.", saferAction: "Ikuti catatan transaksi dan petunjuk penyedia." },
        ],
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        choices: [
          { id: "reject-refund-qr", label: "Jangan pindai; cek pengembalian dana di aplikasi marketplace", quality: "safe", points: 100, feedback: "Memasukkan PIN setelah memindai QR biasanya menyetujui tindakan dari akunmu, bukan menerima dana." },
          { id: "scan-check-amount", label: "Pindai dulu lalu batal jika ada jumlah pembayaran", quality: "partial", points: 30, feedback: "Pemindaian dapat membuka situs atau proses berisiko, meski kamu belum menekan Bayar.", saferAction: "Gunakan menu pengembalian dana resmi di aplikasi." },
          { id: "scan-enter-pin", label: "Pindai dan masukkan PIN untuk menerima dana", quality: "unsafe", points: 0, feedback: "PIN dapat menyetujui pembayaran atau akses yang justru mengurangi saldo.", saferAction: "Jangan masukkan PIN karena petunjuk dari chat." },
        ],
      },
      {
        ...
        choices: [
          ...
          { id: "show-screenshot-only", label: "Tunjukkan tangkapan layar lalu anggap masalah selesai", quality: "partial", points: 35, feedback: "Tangkapan layar membantu menjelaskan masalah, tetapi status transaksi tetap perlu diperiksa oleh penyedia.", saferAction: "Gunakan riwayat transaksi dan layanan bantuan resmi." },
        ],
      },
    ],
  },
    ...
    steps: [
      {
        ...
        choices: [
          ...
          { id: "reply-for-tracking", label: "Balas dan minta nomor resi", quality: "partial", points: 30, feedback: "Nomor resi dapat dibuat atau dicuri dan kamu masih berbicara dengan pengirim yang sama.", saferAction: "Periksa pesanan dari aplikasi atau akun resmi." },
      ...
      },
      {
        ...
        choices: [
          { id: "inspect-main-domain", label: "Cari alamat utama atau gunakan aplikasi resmi", quality: "safe", points: 100, feedback: "Bagian depan dan belakang alamat dapat memuat nama apa pun; alamat utama menentukan situs yang dikunjungi." },
          { id: "trust-lock-icon", label: "Percaya jika ada ikon gembok", quality: "partial", points: 20, feedback: "HTTPS melindungi koneksi, tetapi tidak membuktikan pemilik situs adalah merek yang diklaim.", saferAction: "Periksa alamat utama dan buka aplikasi atau situs resmi." },
      ...
      },
      {
        ...
        choices: [
          { id: "close-check-official", label: "Tutup halaman dan cek tagihan dari aplikasi atau situs resmi", quality: "safe", points: 100, feedback: "Kamu tidak memberikan data kartu dan kode masuk ke halaman yang belum dapat dipercaya." },
