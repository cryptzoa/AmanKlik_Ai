...
export function publicErrorResponse(error: unknown) {
  ...
  const status = code === "RATE_LIMITED" ? 429 : code === "FILE_TOO_LARGE" ? 413 : code === "UNSUPPORTED_FILE" ? 415 : code === "AI_IMAGE_ANALYSIS_UNAVAILABLE" ? 503 : code === "INTERNAL_ERROR" ? 503 : 400;
